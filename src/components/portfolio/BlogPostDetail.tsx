...
import { blogPosts, Comment } from '../../data/blogMockData';
...
export function BlogPostDetail() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-4xl font-bold mb-4">Article non trouvé</h2>
  ...
  // Helper to parse content and inject CodeHighlighter for <pre><code> blocks
  const renderContent = (htmlContent: string) => {
    ...
    return parts.map((part, index) => {
      ...
      return <div key={index} className="prose prose-invert prose-primary max-w-none mb-6" dangerouslySetInnerHTML={{ __html: part }} />;
    });
  };
        ...
        <section className="pt-16 border-t border-border">
          ...
          <form onSubmit={handleAddComment} className="mb-16 p-8 rounded-3xl bg-card border border-border shadow-lg">
            ...
            <textarea
              ...
              rows={4}
              className="w-full bg-background border-border rounded-2xl p-6 focus:ring-2 focus:ring-primary transition-all resize-none mb-6"
            />
