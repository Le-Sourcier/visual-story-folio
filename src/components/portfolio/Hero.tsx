  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 px-6 overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="text-muted-foreground/30 italic font-light">Digitale.</span>
            </motion.h1>
          </div>
          ...
          >
            <a href="#work" className="group relative px-10 py-5 bg-primary text-primary-foreground rounded-2xl font-black text-lg overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-2xl">
              <span className="relative z-10 flex items-center gap-3">
                Mes Projets <ArrowDown className="w-5 h-5 group-hover:translate-y-1 transition-transform" />
              </span>
      ...
      <div className="absolute right-12 top-1/2 -translate-y-1/2 hidden lg:flex flex-col items-center gap-8">
        ...
        <span className="[writing-mode:vertical-lr] text-[10px] font-black uppercase tracking-[0.5em] text-muted-foreground/50">Explorer mon univers</span>
